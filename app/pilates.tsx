    ...
    <LecturePage className="bg-ternary" image="/foto/276A7592.jpg" title="Pilates" page="01.a" id="Pilates" isLecture>
      <div className="my-auto w-full flex flex-col gap-20">
        ...
        <Typography variant="lead" className="max-w-[60%] self-center">
          Během 60 minutové lekce nejdříve zvýšíme činnost kardiovaskulárního systému (zvýšíme tepovou frekvenci) a poté se zaměříme na posílení celého těla, na
          konci lekce posledních 10 min věnujeme protažení. Výsledkem bude lepší stabilita, flexibilita, zpevněné tělo, eliminuje se bolest zad, celkový pocit
