...
const Workshops = () => {
  ...
  return (
    <>
      <div id="zenamu-workshops" calendar-id="59d35f2081b9da062ef0daf743867a07"></div>
      {!isLoaded && <div className="min-h-[400px] flex items-center justify-center">Načítám workshopy...</div>}
    </>
  );
};
